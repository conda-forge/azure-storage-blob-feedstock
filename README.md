...
Once the `conda-forge` channel has been enabled, `azure-storage-blob` can be installed with `conda`:
...
It is possible to list all of the versions of `azure-storage-blob` available on your platform with `conda`:
