...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/azure-storage-blob-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/azure-storage-blob-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add azure-storage-blob
# for installing globally
pixi global install azure-storage-blob
```
...
It is possible to list all of the versions of `azure-storage-blob` available on your platform:
...
```
mamba search azure-storage-blob --channel conda-forge
```
...
```
pixi search azure-storage-blob --channel conda-forge
```
...
mamba repoquery search azure-storage-blob --channel conda-forge

# List packages depending on `azure-storage-blob`:
mamba repoquery whoneeds azure-storage-blob --channel conda-forge

# List dependencies of `azure-storage-blob`:
mamba repoquery depends azure-storage-blob --channel conda-forge
```
